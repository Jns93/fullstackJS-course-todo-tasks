...
insert into branas.column (id_column, id_board, name, has_estimative) values (3, 1, 'Coluna C', false);
insert into branas.card (id_card, id_column, title, estimative) values (1, 1, 'Atividade 1', 1);
insert into branas.card (id_card, id_column, title, estimative) values (2, 1, 'Atividade 2', 1);
